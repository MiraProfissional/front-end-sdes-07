...
describe('<SobreNos />', () => {
  ...
  it('should load images correctly', () => {
    ...
    expect(backgroundImage).toHaveAttribute('src', expect.stringContaining('.png'));
    expect(teamImage).toHaveAttribute('src', expect.stringContaining('https://th.bing.com/th/id/OIP.KPwLL2a-vw67al0B_rGMQAHaE7?rs=1&pid=ImgDetMain'));
  });
